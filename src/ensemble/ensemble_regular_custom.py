"""
Multi-Model Ensemble Bias Detection System with Collaborative Discussion (Custom Dataset Version)

This system combines three LLMs (Qwen3, Llama3.1, GPT-OSS) for political bias detection on custom datasets without ground truth:
